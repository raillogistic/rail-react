...
export const LOOKUP_LABELS_FR: Record<FilterOptionType["lookup_expr"], string> =
  {
    ...
    count: "Nombre égal à",
    count_gt: "Nombre supérieur à",
    count_gte: "Nombre supérieur ou égal à",
    count_lt: "Nombre inférieur à",
    count_lte: "Nombre inférieur ou égal à",
  };
        ...
        <div className="grid gap-2 md:grid-cols-[minmax(0,1fr)_auto]">
          ...
          <div className="flex items-center gap-3 self-end justify-self-end">
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button
                  ...
                  title={
                    option
                      ? `Opérateur: ${translateLookup(option.lookup_expr)}`
            ...
            {/* <div className="text-sm font-medium text-foreground line-clamp-1 hidden md:block">
                {option ? translateLookup(option.lookup_expr) : "Choisir un opérateur"}
              </div> */}
            {/* </div> */}
          </div>
        </div>

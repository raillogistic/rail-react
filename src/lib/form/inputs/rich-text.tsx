...
const RichTextInput: React.FC<Props> = ({ config, field, form }) => {
  ...
  return (
    <FieldWrapper config={config} fieldId={fieldId} error={error} dirty={dirty}>
      <div
        className={cn(
          "flex flex-col overflow-hidden rounded-lg border border-border/60 bg-background/50 transition-all focus-within:border-primary/50 focus-within:ring-4 focus-within:ring-primary/5",

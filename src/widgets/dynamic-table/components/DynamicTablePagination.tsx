 ...
 * Features a refined visual treatment with rounded containers, subtle backgrounds,
...
export function DynamicTablePagination({
  ...
  return (
    <TooltipProvider delayDuration={300}>
      <div
        className={cn(
          "mt-3 flex flex-col items-center justify-between gap-3 rounded-2xl border border-border/30 bg-background/60 px-4 py-3 backdrop-blur-xl shadow-sm sm:flex-row",
      ...
      >
        ...
        <div className="flex items-center gap-3 text-xs text-muted-foreground">
          {enableSelection && selectedCount > 0 ? (
            <span className="inline-flex items-center gap-1.5 rounded-full bg-primary/10 px-3 py-1 text-[11px] font-bold text-primary animate-in zoom-in-95 duration-200">
        ...
        <div className="flex flex-wrap items-center justify-center gap-2 sm:justify-end">
          ...
          >
            <SelectTrigger className="h-8 w-[90px] rounded-xl border-border/30 bg-muted/30 text-[11px] font-semibold transition-all hover:bg-muted/50">
              <SelectValue />
            </SelectTrigger>
            <SelectContent className="rounded-xl border-border/30 bg-background/95 shadow-xl backdrop-blur-xl">
          ...
          {/* Navigation Cluster */}
          <div className="flex items-center gap-1 rounded-xl bg-muted/30 p-1 border border-border/20">
            {/* First */}
            <Tooltip>
              <TooltipTrigger asChild>
                <Button
                  ...
                  variant="ghost"
                  size="icon"
                  className="hidden h-7 w-7 rounded-lg lg:flex hover:bg-background hover:text-primary disabled:opacity-20 transition-all active:scale-90"
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <Button
                  ...
                  variant="ghost"
                  size="icon"
                  className="h-7 w-7 rounded-lg hover:bg-background hover:text-primary disabled:opacity-20 transition-all active:scale-90"
                  disabled={!canGoPrevious}
            ...
            <div className="flex items-center justify-center min-w-[80px] px-2">
              {isJumpMode ? (
                <div className="flex items-center gap-1 animate-in zoom-in-95 duration-200">
                  <input
                    autoFocus
                    className="h-7 w-12 rounded-md border border-primary/30 bg-background/80 px-1.5 text-center text-xs font-bold tabular-nums focus:outline-none focus:ring-1 focus:ring-primary/20"
                  ...
                  <Button
                    ...
                    size="icon"
                    variant="ghost"
                    className="h-7 w-7 rounded-md text-primary bg-primary/5"

...
export const FilterRow: React.FC<FilterRowProps> = ({
 ...
 return (
 <div className="flex items-center gap-3 p-2 px-3 border border-destructive/20 bg-destructive/5 animate-in shake-in duration-300">
 <div className="p-1 bg-destructive/10 text-destructive">
 ...
 variant="ghost"
 size="icon"
 className="h-8 w-8 ml-auto hover:bg-destructive/10 text-destructive/60 hover:text-destructive"
 onClick={onRemove}
 disabled={disabled}
 >
 <X className="h-4 w-4" />
 ...
 <div
 className={cn(
 "group/filter-row flex flex-wrap items-center gap-2 border border-border/50 bg-background px-3 py-2 transition-all duration-200 hover:border-primary/30 hover:shadow-sm",
 ...
 variant="ghost"
 size="sm"
 className="h-8 pl-1 pr-2.5 gap-2 text-xs font-semibold bg-muted/40 hover:bg-muted transition-colors border-transparent hover:border-border/50 border"
 disabled={disabled}
 >
 <div className="flex items-center justify-center h-6 w-6 bg-background text-primary/70 shadow-sm border border-border/40">
 {fieldIcon}
 </div>
 ...
 >
 <SelectTrigger
 className="h-8 w-[84px] text-[10px] font-bold uppercase tracking-wider bg-muted/30 border-transparent hover:border-border/50 transition-all focus:ring-0"
 ...
 className="w-full h-8 text-xs transition-all focus-within:ring-1 focus-within:ring-primary/20"
 />
 </div>

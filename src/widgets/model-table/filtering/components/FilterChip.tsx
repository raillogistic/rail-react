...
export const FilterChip: React.FC<FilterChipProps> = ({
 ...
 <div
 className={cn(
 "group inline-flex items-center gap-0 border border-primary/20 bg-primary/5 pl-2 pr-1 py-0.5 text-[11px] hover:bg-primary/10 hover:border-primary/40 transition-all cursor-pointer animate-in fade-in-0 zoom-in-95 duration-200"
 )}
 onClick={onClick}
 >
 ...
 variant="ghost"
 size="icon"
 className="h-5 w-5 text-muted-foreground/50 hover:text-destructive hover:bg-destructive/10 transition-colors ml-0.5"
 onClick={(event) => {

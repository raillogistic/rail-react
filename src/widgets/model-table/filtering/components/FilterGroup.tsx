...
export const FilterGroupComponent: React.FC<FilterGroupProps> = ({
 ...
 showNegationWarning &&
 "border border-destructive/30 bg-destructive/5 p-4 shadow-sm ring-1 ring-destructive/10",
 ...
 {depth > 0 && (
 <div className="absolute left-[-2px] top-0 bottom-0 w-[2px] bg-primary/20 " />
 )}

 {/* Group Header */}
 <div className="flex items-center gap-3 mb-3">
 <div className="flex items-center gap-2 bg-muted/50 p-1 border border-border/40">
 <ToggleGroup
 type="single"
 size="sm"
 value={group.logic}
 ...
 {config.enableNot && (
 <div className="flex items-center gap-2 mr-2 bg-muted/30 px-2 py-1">
 ...
 {showNegationWarning && (
 <div className="flex items-center gap-2 mb-3 text-[11px] font-medium text-destructive bg-destructive/10 px-3 py-1.5 border border-destructive/20 animate-in fade-in slide-in-from-top-1">
 ...
 <Button
 variant="outline"
 className="w-full h-11 border-dashed border-primary/20 bg-primary/5 text-primary hover:bg-primary/10 hover:border-primary/40 transition-all "
 >
 ...
 variant="ghost"
 size="sm"
 className="flex-1 h-9 text-xs font-semibold text-primary hover:bg-primary/10 hover:text-primary transition-all"
 >
 ...
 variant="outline"
 size="icon"
 className="h-9 w-9 border-dashed border-muted-foreground/30 hover:border-primary/50 hover:bg-primary/5 hover:text-primary transition-all"

...
export const ActiveFiltersBar: React.FC<ActiveFiltersBarProps> = ({
 ...
 size="sm" 
 onClick={onAddFilter}
 className="h-8 border-dashed border-muted-foreground/30 hover:border-primary/50 hover:bg-primary/5 transition-all text-xs font-medium"
 >
 ...
 <Badge variant="secondary" className="h-6 bg-muted/50 text-[10px] font-bold cursor-help px-2 border-transparent hover:bg-muted transition-colors">
 +{overflow} de plus
 </Badge>
 </TooltipTrigger>
 ...
 size="sm" 
 onClick={onAddFilter}
 className="h-8 w-8 hover:bg-primary/5 hover:text-primary transition-all p-0"
 >
 ...
 size="sm" 
 onClick={onClearAll}
 className="h-8 w-8 hover:bg-destructive/5 hover:text-destructive transition-all p-0"
 >

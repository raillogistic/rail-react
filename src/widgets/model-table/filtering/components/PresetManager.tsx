...
export const PresetManager: React.FC<PresetManagerProps> = ({
 ...
 if (!hasAnyPresets) {
 return (
 <div className="flex flex-col items-center justify-center py-12 text-muted-foreground/50 border border-dashed bg-muted/5">
 ...
 className="w-full h-10 pl-10 pr-4 bg-muted/30 border-transparent text-sm focus:bg-background focus:ring-1 focus:ring-primary/20 transition-all outline-none border hover:border-border/60"
 value={search}
 ...
 aria-expanded={open}
 className={cn(
 "justify-between gap-2 h-9 border-muted-foreground/20 bg-background hover:bg-muted/50 transition-all",
 ...
 <PopoverContent
 className="w-[320px] p-0 border-border/50 shadow-2xl overflow-hidden"
 align="start"
 >
 <Command>
 <CommandInput
...
// <Card
// className={cn(
// "group/card border bg-background/50 hover:bg-background hover:shadow-md hover:border-primary/30 transition-all duration-200 overflow-hidden cursor-pointer",
...
// </Button>
// </DropdownMenuTrigger>
// <DropdownMenuContent align="end" className="shadow-xl border-border/50 min-w-[140px]">
...
// <DropdownMenuContent
// align="end"
// className="shadow-xl border-border/50 min-w-[140px]"
// >
// <DropdownMenuItem
// onClick={(e) => {
// e.stopPropagation();
...
const PresetItem: React.FC<PresetItemProps> = ({
 ...
 <div
 className={cn(
 "h-4 w-4 border flex items-center justify-center shrink-0 transition-all",
 isSelected

...
export function QuickSearch({
 ...
 <Input
 className={cn(
 "h-9 w-full pl-10 pr-9 bg-muted/30 border-none transition-all duration-300 ",
 ...
 <button
 onClick={() => onChange("")}
 className="absolute right-2 top-1/2 -translate-y-1/2 p-1.5 hover:bg-primary/10 hover:text-primary transition-all active:scale-90 animate-in fade-in zoom-in-75 duration-300"
 >
 <X className="h-3.5 w-3.5" />
 </button>
 )}
 <div className={cn(
 "absolute bottom-0 left-1/2 -translate-x-1/2 h-[2px] bg-primary transition-all duration-500 ",

...
function SortHandleButton({
  ...
  return (
    <button
      ...
      className="p-1 text-muted-foreground/20 transition-all hover:text-primary hover:bg-primary/5 cursor-grab active:cursor-grabbing focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/20"
  ...
  return (
    <div
      ...
      className={cn(
        ...
        isDragging &&
          "opacity-40 scale-[0.98] z-50 ring-1 ring-primary/15 bg-muted/30 ",
      )}
    >
...
function FieldLeafRow({
  ...
  return (
    <div
      className={cn(
        "group/leaf relative flex items-center gap-2.5 border border-transparent px-2.5 py-1.5 transition-all",
    ...
    >
      ...
      <label className="flex min-w-0 flex-1 cursor-pointer items-center gap-2.5">
        <Checkbox
          ...
          className="size-4 border-muted-foreground/25 transition-all data-[state=checked]:bg-primary data-[state=checked]:border-primary"
        />
...
function RelationFieldRow({
  ...
  return (
    ...
    >
      <div
        className={cn(
          "flex items-center gap-2.5 border border-transparent px-2.5 py-1.5 transition-all",
          selected
      ...
      >
        ...
        <CollapsibleTrigger asChild>
          <button
            type="button"
            className={cn(
              " p-0.5 text-muted-foreground/30 transition-all hover:bg-primary/5 hover:text-primary",
        ...
        <div className="flex min-w-0 flex-1 flex-col">
          <div className="flex flex-wrap items-center gap-1.5">
            ...
            <Badge
              variant="outline"
              className={cn(
                "h-4 px-1.5 text-[8px] font-bold uppercase tracking-tight ",
                relation?.isToMany
        ...
        <CollapsibleContent className="ml-7 mt-0.5 space-y-0.5 relative overflow-hidden">
          ...
          <div className="pl-3.5 pb-1.5">
            {metadata ? (
              ...
              <div className="bg-destructive/5 px-2.5 py-1.5 text-[10px] font-medium text-destructive/70">
    ...
    <div className="w-full">
      {filteredFields.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-10 text-center">
          <div className="flex size-10 items-center justify-center bg-muted/25 mb-3">

...
export function ModelTableHeader({
 ...
 {/* Subtle Icon */}
 <div className="hidden sm:flex size-10 shrink-0 items-center justify-center bg-gradient-to-br from-primary/10 to-primary/5 text-primary border border-primary/20 shadow-sm">
 ...
 <Badge
 variant="secondary"
 className="h-6 px-2.5 bg-secondary/80 text-secondary-foreground hover:bg-secondary/60 border-none text-[11px] font-bold tabular-nums transition-colors"
 ...
 <Badge
 className="h-6 px-2.5 bg-primary text-primary-foreground border-none text-[11px] font-bold shadow-sm animate-in zoom-in-95 duration-200 tabular-nums"
 ...
 className={cn(
 "flex size-9 items-center justify-center border shadow-sm transition-all focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring",
 controller.loading

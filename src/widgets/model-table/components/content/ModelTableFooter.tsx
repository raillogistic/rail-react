 ...
 * Premium styled with rounded container, muted icon, and subtle typography.
 */
export function ModelTableFooter({ controller }: ModelTableFooterProps) {
  return (
    <div className="flex items-center justify-between rounded-xl border border-border/20 bg-muted/20 px-4 py-2.5 text-[11px] font-medium text-muted-foreground/70 backdrop-blur-sm">

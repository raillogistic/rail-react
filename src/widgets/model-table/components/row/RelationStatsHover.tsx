...
`${base}DistinctCount`,
 ...
 <p className="inline-flex items-center gap-2 border border-border/60 bg-muted/30 px-2 py-1.5">
 <Loader2 className="h-3.5 w-3.5 animate-spin" />
 Chargement...
 </p>
 ) : error ? (
 <p className="border border-destructive/30 bg-destructive/10 px-2 py-1.5 text-destructive">
 {error}
 </p>
 ) : statEntries.length ? (
 <>
 {summaryEntry ? (
 <div className="border border-border/70 bg-card/90 px-3 py-2">
 ...
 className="border border-border/60 bg-background/80 p-2"
 >
 ...
 <div
 key={entry.key}
 className="border border-border/40 bg-muted/30 px-2 py-1"
 >

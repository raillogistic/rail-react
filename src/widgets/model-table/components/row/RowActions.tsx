 ...
 */
 ...
 className="group/item flex items-center gap-3 py-2.5 text-xs font-medium transition-all"
 >
 <div
 className={cn(
 ...
 className="group/custom flex items-center gap-3 py-2.5 text-xs font-medium transition-all"
 >
 <div
 className={cn(
 "flex h-8 w-8 items-center justify-center transition-colors",

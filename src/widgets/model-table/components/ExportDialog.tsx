...
import type { FilterQueryVariables } from "@/widgets/model-table/filtering/types";
...
export function ModelTableExportDialog({
  ...
  const handleExport = useCallback(async () => {
    ...
    const exportEndpoint = getRuntimeBackendConfig().exportEndpoint;
  ...
  const resolvedTrigger = useMemo(() => {
    if (!trigger) {
      return (
        <Button
          ...
          className="size-8 border-border/30 hover:bg-primary/5 hover:text-primary transition-all active:scale-95 disabled:opacity-50"
    ...
    return cloneElement(trigger, {
      ...
      title:
        existingTitle ??
        (effectiveDisabled ? triggerDisabledReason : undefined),
      className: cn(
        existingClassName,
          ...
          <div className="flex-1 min-h-0 grid gap-0 md:grid-cols-[2.5fr,1fr] overflow-hidden">
              ...
              <div className="flex-none space-y-3 px-6 py-4 border-b border-border/10">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex gap-2">
                    <Button
                      ...
                      className="h-7 text-[10px] font-bold uppercase tracking-wider hover:bg-primary/10 hover:text-primary transition-all"
                    >
                    ...
                    <Button
                      ...
                      size="sm"
                      onClick={clearFields}
                      className="h-7 text-[10px] font-bold uppercase tracking-wider hover:bg-destructive/10 hover:text-destructive transition-all"
                    >
                ...
                <div className="relative group">
                  ...
                  <Input
                    ...
                    className="pl-9 h-9 bg-background/50 border-border/20 text-xs font-medium transition-all"
                  />
                  {searchQuery && (
                    <button
                      onClick={() => setSearchQuery("")}
                      className="absolute right-2 top-1/2 -translate-y-1/2 p-1 hover:bg-muted transition-all"
                    >
            ...
            <div className="flex flex-col bg-muted/5 overflow-hidden">
              <div className="flex-1 p-5 space-y-5 overflow-y-auto custom-scrollbar">
                    ...
                    <div className="space-y-1.5">
                      ...
                      <div className="relative group">
                        <Input
                          ...
                          className="h-8 bg-background/50 border-border/20 text-xs font-medium transition-all"
                        />
                    ...
                    <div className="space-y-1.5">
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        <button
                          ...
                          className={cn(
                            "flex items-center justify-center gap-2 py-2 px-3 border transition-all",
                            fileExtension === "xlsx"
                ...
                {/* Status Group */}
                {exportError ? (
                  <div className="border border-destructive/20 bg-destructive/5 p-3 text-[11px] font-medium text-destructive">
                    <div className="flex gap-2">
          ...
          <DialogFooter className="px-6 py-4 border-t border-border/15 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between flex-none">
            ...
            <div className="flex w-full justify-end gap-2 sm:w-auto">
              <Button
                ...
                className="h-9 px-5 text-xs font-semibold transition-all"
              >

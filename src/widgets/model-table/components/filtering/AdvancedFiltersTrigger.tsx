...
export const AdvancedFiltersTrigger: React.FC<AdvancedFiltersTriggerProps> = ({
 ...
 {label}
 {isActive ? (
 <span className="ml-2 bg-primary/10 px-2 text-xs font-semibold text-primary">
 {activeCount}
 </span>
 ) : null}
 </Button>
 ...
 {isActive ? (
 <span className="absolute -right-1 -top-1 flex h-4 w-4 items-center justify-center bg-primary text-[10px] font-semibold text-background">

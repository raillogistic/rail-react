...
export const FilterFieldSelector: React.FC<Props> = ({
 ...
 <div className="mb-2 flex items-center gap-2 border px-2 py-1">
 ...
 return (
 <div key={group.key} className="border px-2 py-1.5">
 <button
 type="button"
 ...
 type="button"
 className={cn(
 "flex w-full items-start gap-2 px-2 py-1.5 text-left text-sm hover:bg-muted/70",
 ...
 {item.path_labels.slice(0, -1).join("â–¸ ")}
 </span>
 )}
 </button>
 ))}

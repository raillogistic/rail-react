    ...
    <SidebarMenu>
      <SidebarMenuItem>
        <DropdownMenu>
          ...
          <DropdownMenuContent
            className="w-72 rounded-[1.5rem] border-sidebar-border/40 bg-sidebar/95 p-2.5 backdrop-blur-2xl shadow-[0_20px_50px_rgba(0,0,0,0.2)] animate-in zoom-in-95 duration-200"

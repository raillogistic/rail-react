...
`[data-option-index="${highlightedIndex}"]`,
 ...
 key={option.value}
 className={cn(
 "relative flex cursor-pointer select-none items-center py-2.5 pl-9 pr-3 outline-none transition-colors",
 ...
 <DialogContent className="sm:max-w-3xl overflow-hidden p-0 border-border/40 shadow-2xl">

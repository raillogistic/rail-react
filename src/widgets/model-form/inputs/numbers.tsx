...
const NumberInput: React.FC<Props> = ({ config, field, form }) => {
 ...
 className={cn(
 "h-10 border-border/60 bg-background/50 pl-9 pr-4 transition-all focus:border-primary/50 focus:bg-background focus:ring-4 focus:ring-primary/5 focus-visible:ring-0",

...
const BooleanInput: React.FC<Props> = ({ config, field, form }) => {
 ...
 <div
 className={cn(
 "flex items-center gap-4 border border-border/40 bg-background/50 p-3 transition-all duration-200",
 ...
 <div
 className={cn(
 "flex items-center gap-3 border border-border/40 bg-background/50 px-4 py-3 transition-all duration-200",
 "hover:border-border/80 hover:bg-background",

...
const DateTimeInput: React.FC<Props> = ({ config, field, form }) => {
 ...
 data-slot="input"
 className={cn(
 "h-10 w-full justify-start border-border/60 bg-background/50 px-4 text-left font-normal transition-all",
 ...
 <Input
 type="time"
 className="h-9 border-border/60 bg-background transition-all focus:border-primary/50 focus:ring-4 focus:ring-primary/5"

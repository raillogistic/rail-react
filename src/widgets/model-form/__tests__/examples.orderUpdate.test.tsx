...
vi.mock("@/widgets/model-form", async () => {
 const actual = await vi.importActual<typeof import("@/widgets/model-form")>(
 "@/widgets/model-form",
 );
 return {
 ...actual,
...
describe("StoreOrderUpdateModelFormExample", () => {
 ...
 action: "MERGE",
 value: {
 updated_from: "rail-react/src/widgets/model-form/examples.tsx",
 },
 },
 ]),
 );

export const ROUTES = {
  ...
  ARTICLE_METADATA_VALEUR_LIST: "/catalog/article-metadata-valeur",
  ARTICLE_LIST: "/catalog/article",
  ARTICLE_CREATE: "/catalog/article/create",
  ARTICLE_EDIT: "/catalog/article/:id/edit",
  ARTICLE_DETAIL: "/catalog/article/:id",
